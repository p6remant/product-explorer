  ...
  return (
    <>
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        {/* Spacer matching fixed footer height so bottom content stays visible */}
        <div aria-hidden className="pointer-events-none lg:hidden">
          <div className="invisible border-t p-4 pb-[max(1rem,env(safe-area-inset-bottom))]">
      ...
      <div className="border-divider bg-app-surface/95 fixed inset-x-0 bottom-0 z-40 border-t p-4 pb-[max(1rem,env(safe-area-inset-bottom))] backdrop-blur-md lg:hidden">
        <Button
          variant="primary"
          size="lg"
          className="w-full"
